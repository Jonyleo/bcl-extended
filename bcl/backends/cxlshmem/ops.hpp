...
namespace BCL {
  ...
  struct atomic_op : public virtual abstract_op <T> {
    virtual T cxlshm_atomic_op(const GlobalPtr <T> ptr, const T &val) const = 0;
  };
  ...
  struct swap<unsigned long long> : public abstract_swap<unsigned long long>, public abstract_ulonglong, public atomic_op<unsigned long long> {
    unsigned long long cxlshm_atomic_op(const GlobalPtr<unsigned long long> ptr, const unsigned long long& val) const {
      unsigned long long tmp = *(ptr.local());
      *(ptr.local()) = val;
      val = tmp;
  ...
  struct xor_<int> : public abstract_xor_<int>, public abstract_int, public atomic_op<int> {
    int cxlshm_atomic_op(const GlobalPtr<int> ptr, const int& val) const {
